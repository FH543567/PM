...
const task2: Task = new Task(2, 'Task 2', 'Beschreibung Task 2', 2, 20, 2, 2, 1);
const task3: Task = new Task(3, 'Task 3', 'Beschreibung Task 3', 1, 5, 4, 1, 2);
const task4: Task = new Task(4, 'Task 4', 'Beschreibung Task 4', 3, 50, 1, 2);
const task5: Task = new Task(5, 'Task 5', 'Beschreibung Task 5', 1, 40, 31, 2, 2);

const story1: Story = new Story(1, 'Story 1', 'Beschreibung Story 1', 3, 1);
const story2: Story = new Story(2, 'Story 2', 'Beschreibung Story 2', 2, 1);
const story3: Story = new Story(3, 'Story 3', 'Beschreibung Story 3', 1, 4);
const story4: Story = new Story(1, 'Story 4', 'Beschreibung Story 4', 1, );
...
const sprint1: Sprint = new Sprint(1, 'Sprint 1', 'Beschreibung Sprint 1', 5, new Date('2017-12-15'), new Date(2017, 12, 31));
const sprint2: Sprint = new Sprint(2, 'Sprint 2', 'Beschreibung Sprint 2', 5, new Date(2018, 1, 7), new Date(2018, 1, 14));
