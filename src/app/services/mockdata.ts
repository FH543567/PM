...
const task1: Task = new Task(1, 'Task 1', 'Beschreibung Task 1', 3, 10, 0, 1, 1, 1);
const task2: Task = new Task(2, 'Task 2', 'Beschreibung Task 2', 2, 20, 2, 3, 1, 1);
const task3: Task = new Task(3, 'Task 3', 'Beschreibung Task 3', 1, 5, 4, 2, 2, 2);
const task4: Task = new Task(4, 'Task 4', 'Beschreibung Task 4', 3, 50, 1, 3, 1, 2);
const task5: Task = new Task(5, 'Task 5', 'Beschreibung Task 5', 1, 40, 40, 4, 2, 2);

const sprint1: Sprint = new Sprint(1, 'Sprint 1', 'Beschreibung Sprint 1', 24,
  new Date('2017-12-15'), new Date(2017, 12, 31));
const sprint2: Sprint = new Sprint(2, 'Sprint 2', 'Beschreibung Sprint 2', 50,
  new Date(2018, 1, 7), new Date(2018, 1, 14));
const sprint3: Sprint = new Sprint(3, 'Sprint 3', 'Beschreibung Sprint 3', 100,
  new Date(2018, 2, 12), new Date(2018, 3, 19));
...
export const SPRINTS: Sprint[] = [sprint1, sprint2, sprint3];
