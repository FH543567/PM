...
const story1: Story = new Story(1, 'Story 1', 'Beschreibung Story 1', 3, [task1, task3]);
const story2: Story = new Story(2, 'Story 2', 'Beschreibung Story 2', 2, [task2, task4, task5]);
const story3: Story = new Story(3, 'Story 3', 'Beschreibung Story 3', 1, [task1, task5]);
const story4: Story = new Story(1, 'Story 4', 'Beschreibung Story 4', 1, [task4, task1, task2]);

const epic1: Epic = new Epic(1, 'Epic 1', 'Beschreibung Epic 1', 1, [story1, story2]);
const epic2: Epic = new Epic(2, 'Epic 2', 'Beschreibung Epic 2', 2, [story3, story1]);
const epic3: Epic = new Epic(3, 'Epic 3', 'Beschreibung Epic 3', 1, [story2]);
const epic4: Epic = new Epic(4, 'Epic 4', 'Beschreibung Epic 4', 3, [story1, story2, story3]);
